...
class CBCurrencyConverterHelper {
	...
	public static function settings_fields() {
		...
		$tools_settings = [
			...
			'reset_data'      => [
				...
				'desc'     => $table_html . '<p>' . esc_html__( 'Reset option values created by this plugin', 'cbcurrencyconverter' ) . '<a data-busy="0" class="button secondary ml-20" id="reset_data_trigger"  href="#">' . esc_attr__( 'Reset Data', 'cbcurrencyconverter' ) . '</a></p>',
				'type'     => 'html',
				'default'  => '',
				'desc_tip' => true,
			],
			'reset_transient' => [
				...
				'desc'     => $transient_table_html . '<p><a id="reset_transient_trigger" data-confirm-title="' . esc_attr__( 'Reset Api Rate cache', 'cbcurrencyconverter' ) . '" data-confirm="' . esc_attr__( 'Are you sure to reset currency rate cache, this process can not be undone?', 'cbcurrencyconverter' ) . '" class="button secondary" href="#">' . esc_attr__( 'Reset Api Rate cache',
						'cbcurrencyconverter' ) . '</a></p>',
				'type'     => 'html',
				'default'  => '',
				'desc_tip' => true,
			],
	...
	public static function setting_reset_html_table() {
		...
		$table_html .= '<p style="margin-bottom: 10px;" class="grouped gapless grouped_buttons" id="cbcurrencyconverter_setting_options_check_actions"><a href="#" class="button primary cbcurrencyconverter_setting_options_check_action_call">' . esc_html__( 'Check All', 'cbcurrencyconverter' ) . '</a><a href="#" class="button outline cbcurrencyconverter_setting_options_check_action_ucall">' . esc_html__( 'Uncheck All', 'cbcurrencyconverter' ) . '</a></p>';
  ...
  <label for="reset_options_' . esc_attr( $value['option_name'] ) . '">' . esc_attr( $value['option_name'] ) . '</td>
	...
	public static function cbcurrencyconverter_rate( $from = '', $to = '', $amount = 1, $decimal_point = 2 ) {
		...
		$decimal_point = absint( $decimal_point );
