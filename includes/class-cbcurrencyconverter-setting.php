...
if ( ! class_exists( 'CBCurrencyconverterSetting' ) ):
	...
	class CBCurrencyconverterSetting {
		...
		function callback_multicheck($args, $value = null)
		{
			...
			$html = '<p class="grouped gapless grouped_buttons checkbox_fields_check_actions"><a href="#" class="button primary checkbox_fields_check_action_call">'.esc_html__('Check All', 'cbcurrencyconverter').'</a><a href="#" class="button outline checkbox_fields_check_action_ucall">'.esc_html__('Uncheck All', 'cbcurrencyconverter').'</a></p>';
